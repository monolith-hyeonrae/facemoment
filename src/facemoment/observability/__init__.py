...
class TraceLevel(IntEnum):
    ...
    """
    OFF = 0       # No tracing
    MINIMAL = 1   # Trigger events only
    NORMAL = 2    # Frame summaries + gate changes
...
# Re-export TraceRecord for type hints (defined in records.py)
from facemoment.observability.records import TraceRecord

from facemoment.observability.sinks import FileSink, ConsoleSink, MemorySink, NullSink
